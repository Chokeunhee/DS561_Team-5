...
# PDF 파일 경로 설정
pdf_path_1 = "/Users/chokeunhee/Desktop/vscode/gptapi/parkinfo.pdf" #pdf 경로 입력
pdf_path_2 = "/Users/chokeunhee/Desktop/vscode/gptapi/mokdong_keypoint.pdf" #pdf 경로 입력
...
def generate_qa_from_text(ref1,ref2):
    ...
    prompt = f"""### Instruction ###
                ...
                output의 형식을 맞추어서 QA dataset 만들어줘. (다양한 공원 포함할 것)
